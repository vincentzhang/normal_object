#include "../include/transformation2D2.h"
...
*/
transformation2D2::transformation2D2(Point _t, double _scale, double _rotation)
{
  t=_t;
  scale=_scale;
  rotation=_rotation;
...
transformation2D2::transformation2D2(){}
...
Point2d transformation2D2::doTransformation(Point2d p1)
{
...
vector< vector <Point2d> > transformation2D2::doTransformation(Point2d _transPoint, vector < vector < Point> > _inputPoints, double _scale, double _rotation)
{
  scale=_scale;
  rotation=_rotation;
