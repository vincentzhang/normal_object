...
void callback(const PointCloud::ConstPtr& msg) {
    ...
    if(new_box) {
        ...
        //std::cout << "before getting 3D points" << std::endl;
...
int main(int argc, char** argv) {
    ...
    ros::Subscriber sub_box = nh.subscribe("/bbox", 100, bbox_callback);
    ...
    ros::Publisher object_pub = nh.advertise<normal_object::targetObjects>("target_bbox", 100);
    ...
    */
    ...
    while(ros::ok()) {
      ...
      if(new_box_robot) {
        ...
        object_pub.publish(msg_objectPoints);
